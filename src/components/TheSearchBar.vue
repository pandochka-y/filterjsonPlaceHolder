<template>
  <form class="header__search search">
    <button @click.prevent="searching"
            aria-label="Search"
            class="search__button"
    >
      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-1.5">
        <path
